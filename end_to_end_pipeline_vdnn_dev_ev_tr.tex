...
% in the abstract
\begin{abstract}
Video annotation as a means to gather ground truth is proven to be beneficial in the progress of machine learning(ML) and deep learning(DL) techniques like object detection. 
